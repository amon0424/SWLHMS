namespace Mong
{
    partial class EditHourDataForm
    {
        /// <summary>
        /// 設計工具所需的變數。
        /// </summary>
        ...
        private void InitializeComponent()
        {
			...
			this.ckbFinishDate = new System.Windows.Forms.CheckBox();
			this.label12 = new System.Windows.Forms.Label();
			this.cbbPart = new System.Windows.Forms.ComboBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.dgvHoursData)).BeginInit();
			...
			this.cbxLaborNumber.Size = new System.Drawing.Size(121, 20);
			this.cbxLaborNumber.TabIndex = 4;
			this.cbxLaborNumber.SelectedValueChanged += new System.EventHandler(this.cbbLaborNumber_SelectedValueChanged);
			// 
			// label2
			// 
			...
			this.cbxLaborName.Location = new System.Drawing.Point(183, 27);
			this.cbxLaborName.Name = "cbxLaborName";
			this.cbxLaborName.Size = new System.Drawing.Size(121, 20);
			this.cbxLaborName.TabIndex = 3;
			this.cbxLaborName.SelectedValueChanged += new System.EventHandler(this.cbbLaborNumber_SelectedValueChanged);
			// 
			// label4
			// 
			...
			// dtpDate
			// 
			this.dtpDate.Location = new System.Drawing.Point(38, 53);
			...
			this.dgvPart.Size = new System.Drawing.Size(14, 17);
			this.dgvPart.TabIndex = 16;
			...
			this.btnSearchWorksheet.Text = "列出品號";
			this.btnSearchWorksheet.UseVisualStyleBackColor = true;
			this.btnSearchWorksheet.Visible = false;
			...
			this.panel1.Controls.Add(this.dateFinishDate);
			this.panel1.Controls.Add(this.ckbFinishDate);
			this.panel1.Controls.Add(this.label12);
			this.panel1.Controls.Add(this.cbbPart);
			this.panel1.Controls.Add(this.txtDate);
			this.panel1.Controls.Add(this.cbbWorksheetNubmerS);
			this.panel1.Controls.Add(this.btnSrchWorksheet);
			this.panel1.Controls.Add(this.btnSearchWorksheet);
			...
			this.llbNGTip.LinkColor = System.Drawing.Color.Red;
			this.llbNGTip.Location = new System.Drawing.Point(83, 7);
			this.llbNGTip.Name = "llbNGTip";
			this.llbNGTip.Size = new System.Drawing.Size(45, 12);
			this.llbNGTip.TabIndex = 46;
			this.llbNGTip.TabStop = true;
			this.llbNGTip.Text = "NG提示";
			this.llbNGTip.Visible = false;
			this.llbNGTip.VisitedLinkColor = System.Drawing.Color.Red;
			this.llbNGTip.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llbNGTip_LinkClicked);
			// 
			// label16
			// 
			...
			this.ckbBorrowLine.TabIndex = 1;
			this.ckbBorrowLine.Text = "由產線";
			this.ckbBorrowLine.UseVisualStyleBackColor = true;
			this.ckbBorrowLine.CheckedChanged += new System.EventHandler(this.ckbBorrowLine_CheckedChanged);
			// 
			// cbbBorrowLine
			// 
			this.cbbBorrowLine.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest;
			this.cbbBorrowLine.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
			...
			// rbProduce
			// 
			this.rbProduce.AutoSize = true;
			this.rbProduce.Location = new System.Drawing.Point(5, 16);
			this.rbProduce.Name = "rbProduce";
			this.rbProduce.Size = new System.Drawing.Size(83, 16);
			this.rbProduce.TabIndex = 20;
			this.rbProduce.Text = "生產工作單";
			this.rbProduce.UseVisualStyleBackColor = true;
			this.rbProduce.CheckedChanged += new System.EventHandler(this.rbProduce_CheckedChanged);
			// 
			// rbNonProduce
			// 
			this.rbNonProduce.AutoSize = true;
			this.rbNonProduce.Location = new System.Drawing.Point(450, 15);
			this.rbNonProduce.Name = "rbNonProduce";
			this.rbNonProduce.Size = new System.Drawing.Size(59, 16);
			this.rbNonProduce.TabIndex = 21;
			this.rbNonProduce.Text = "非生產";
			this.rbNonProduce.UseVisualStyleBackColor = true;
			this.rbNonProduce.CheckedChanged += new System.EventHandler(this.rbProduce_CheckedChanged);
			// 
			// cbbNonProduce
			// 
			this.cbbNonProduce.DataSource = this.bsNonProduce;
			this.cbbNonProduce.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbbNonProduce.FormattingEnabled = true;
			this.cbbNonProduce.Location = new System.Drawing.Point(38, 3);
			this.cbbNonProduce.Name = "cbbNonProduce";
			this.cbbNonProduce.Size = new System.Drawing.Size(161, 20);
			this.cbbNonProduce.TabIndex = 0;
			// 
			// label6
			// 
			...
			// tbxRemark
			// 
			this.tbxRemark.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.tbxRemark.Location = new System.Drawing.Point(39, 29);
			...
			this.tbxHour.Text = "1";
			this.tbxHour.Validating += new System.ComponentModel.CancelEventHandler(this.tbxHour_Validating);
			// 
			// lbRemain
			// 
			...
			// dgvHoursData
			// 
			this.dgvHoursData.AllowUserToAddRows = false;
			this.dgvHoursData.AllowUserToResizeRows = false;
			this.dgvHoursData.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			...
			// bsHourData
			// 
			this.bsHourData.ListChanged += new System.ComponentModel.ListChangedEventHandler(this.bsHourData_ListChanged);
			// 
			// groupBox1
			// 
			...
			this.panel2.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.panel2.Controls.Add(this.cbbNonProduce);
			...
			this.cbbLine.Location = new System.Drawing.Point(38, 27);
			this.cbbLine.Name = "cbbLine";
			this.cbbLine.Size = new System.Drawing.Size(80, 20);
			...
			this.label10.Text = "新增資料: 從上方選取工時相關資料，點選\"新增至清單\"";
			// 
			// label8
			// 
			...
			this.label8.Text = "刪除資料:  選取要刪除的資料列，按Delete鍵刪除";
			// 
			// label7
			// 
			...
			this.label7.Text = "最前方有 * 號的為本次輸入的新資料，舊資料不可刪除";
			// 
			// flowLayoutPanel1
			// 
			...
			this.btnStore.Location = new System.Drawing.Point(122, 3);
			...
			this.pnlData.Controls.Add(this.cbbLine);
			...
			this.pnlData.SetFlowBreak(this.label11, true);
			this.label11.ForeColor = System.Drawing.Color.Blue;
			this.label11.Location = new System.Drawing.Point(3, 5);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(149, 12);
			this.label11.TabIndex = 40;
			this.label11.Text = "選定所屬產線、員工、日期";
			// 
			// flowLayoutPanel2
			// 
			this.flowLayoutPanel2.Controls.Add(this.llbUnfilledTip);
			this.flowLayoutPanel2.Location = new System.Drawing.Point(158, 53);
			this.flowLayoutPanel2.Name = "flowLayoutPanel2";
			this.flowLayoutPanel2.Size = new System.Drawing.Size(523, 22);
			this.flowLayoutPanel2.TabIndex = 41;
			// 
			// llbUnfilledTip
			// 
			this.llbUnfilledTip.ActiveLinkColor = System.Drawing.Color.Blue;
			this.llbUnfilledTip.AutoSize = true;
			this.llbUnfilledTip.LinkColor = System.Drawing.Color.Blue;
			this.llbUnfilledTip.Location = new System.Drawing.Point(3, 4);
			this.llbUnfilledTip.Margin = new System.Windows.Forms.Padding(3, 4, 3, 0);
			this.llbUnfilledTip.Name = "llbUnfilledTip";
			this.llbUnfilledTip.Size = new System.Drawing.Size(65, 12);
			this.llbUnfilledTip.TabIndex = 47;
			this.llbUnfilledTip.TabStop = true;
			this.llbUnfilledTip.Text = "未補足提示";
			this.llbUnfilledTip.Visible = false;
			this.llbUnfilledTip.VisitedLinkColor = System.Drawing.Color.Blue;
			this.llbUnfilledTip.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llbUnfilledTip_LinkClicked);
			// 
			// mainContainer
			// 
			...
			this.mainContainer.Location = new System.Drawing.Point(0, 81);
			...
			this.mainContainer.Panel1.Padding = new System.Windows.Forms.Padding(5, 5, 5, 0);
			this.mainContainer.Panel1MinSize = 220;
			// 
			// mainContainer.Panel2
			// 
			this.mainContainer.Panel2.Controls.Add(this.label10);
			this.mainContainer.Panel2.Controls.Add(this.flowLayoutPanel1);
			...
			this.Name = "EditHourDataForm";
			this.ShowIcon = false;
			this.Text = "工時資料登記";
			this.Load += new System.EventHandler(this.EditHourDataForm_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.dgvHoursData)).EndInit();
        ...
        private System.Windows.Forms.Button btnSearchWorksheet;
        private System.Windows.Forms.Panel panel1;
        private System.Windows.Forms.RadioButton rbProduce;
        private System.Windows.Forms.RadioButton rbNonProduce;
        private System.Windows.Forms.ComboBox cbbNonProduce;
        ...
        private System.Windows.Forms.CheckBox ckbBorrowLine;
        private System.Windows.Forms.ComboBox cbbBorrowLine;
        private System.Windows.Forms.SplitContainer mainContainer;
        private System.Windows.Forms.CheckBox ckbOvertime;
        private System.Windows.Forms.MaskedTextBox txtDate;
        private System.Windows.Forms.ComboBox cbbPart;
        private System.Windows.Forms.DateTimePicker dateFinishDate;
        private System.Windows.Forms.CheckBox ckbFinishDate;
        private System.Windows.Forms.Label label12;
        private System.Windows.Forms.Label label13;
		private System.Windows.Forms.Label lbPartCount;
        private System.Windows.Forms.Label label15;
        private System.Windows.Forms.Label lbRemainCount;
