namespace Mong
{
	partial class QualityItemForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// tbxName
			// 
			this.tbxName.Location = new System.Drawing.Point(157, 43);
			this.tbxName.Name = "tbxName";
			this.tbxName.Size = new System.Drawing.Size(181, 22);
			...
			// tbxNumber
			// 
			this.tbxNumber.Location = new System.Drawing.Point(39, 43);
			this.tbxNumber.Name = "tbxNumber";
			this.tbxNumber.Size = new System.Drawing.Size(75, 22);
			this.tbxNumber.TabIndex = 5;
			this.tbxNumber.Validated += new System.EventHandler(this.tbxNumber_Validated);
			// 
			// label1
			// 
			...
			this.Name = "QualityItemForm";
			this.ShowIcon = false;
			this.Text = "品質原因管理";
			this.Load += new System.EventHandler(this.QualityItemForm_Load);
