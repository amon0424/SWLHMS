namespace Mong
{
	partial class InspectForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnNGReason.Text = "…";
			this.btnNGReason.UseVisualStyleBackColor = true;
			this.btnNGReason.Visible = false;
			this.btnNGReason.Click += new System.EventHandler(this.btnNGReason_Click);
			// 
			// rbInspectByPn
			// 
			this.rbInspectByPn.AutoSize = true;
			this.rbInspectByPn.Checked = true;
			this.rbInspectByPn.Font = new System.Drawing.Font("新細明體", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(136)));
			this.rbInspectByPn.Location = new System.Drawing.Point(136, 16);
			this.rbInspectByPn.Name = "rbInspectByPn";
			this.rbInspectByPn.Size = new System.Drawing.Size(266, 20);
			this.rbInspectByPn.TabIndex = 51;
			this.rbInspectByPn.TabStop = true;
			this.rbInspectByPn.Text = "依工作單號及料號顯示累計待驗數";
			...
			this.rbInspectByQcN.Font = new System.Drawing.Font("新細明體", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(136)));
			this.rbInspectByQcN.Location = new System.Drawing.Point(408, 16);
			this.rbInspectByQcN.Name = "rbInspectByQcN";
			this.rbInspectByQcN.Size = new System.Drawing.Size(183, 20);
			this.rbInspectByQcN.TabIndex = 52;
			this.rbInspectByQcN.Text = "依QC#個別顯示待驗數";
			...
			this.ngReasonColumn1.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
			// 
			// dataGridViewTextBoxColumn1
			// 
			this.dataGridViewTextBoxColumn1.DataPropertyName = "待驗提醒";
			...
			// 
			this.dataGridViewTextBoxColumn2.DataPropertyName = "項次";
			...
			// 
			this.dataGridViewTextBoxColumn3.DataPropertyName = "單據日期";
			this.dataGridViewTextBoxColumn3.Frozen = true;
			this.dataGridViewTextBoxColumn3.HeaderText = "單據日期";
			...
			// 
			this.dataGridViewTextBoxColumn6.DataPropertyName = "序號";
			...
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "待驗數量";
			this.dataGridViewTextBoxColumn9.HeaderText = "待驗數量";
			...
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "QCN";
			this.dataGridViewTextBoxColumn10.HeaderText = "QC#";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "送檢次數";
			this.dataGridViewTextBoxColumn11.HeaderText = "送檢次數";
			...
			// 
			this.dataGridViewTextBoxColumn14.DataPropertyName = "重檢";
			this.dataGridViewTextBoxColumn14.HeaderText = "重檢QC#筆數";
			this.dataGridViewTextBoxColumn14.Name = "dataGridViewTextBoxColumn14";
			this.dataGridViewTextBoxColumn14.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn15
			// 
			this.dataGridViewTextBoxColumn15.DataPropertyName = "QCN";
			this.dataGridViewTextBoxColumn15.HeaderText = "QC#";
			...
			// 
			this.dataGridViewTextBoxColumn16.DataPropertyName = "送檢次數";
			this.dataGridViewTextBoxColumn16.HeaderText = "送檢次數";
			...
			this.ngReasonColumn2.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
			// 
		...
		private System.Windows.Forms.Button btnNGReason;
		...
		private NGReasonColumn buttonTextboxColumn1;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn colEstShipDate;
		private System.Windows.Forms.DataGridViewTextBoxColumn col已完成;
		private System.Windows.Forms.DataGridViewTextBoxColumn colInspectNum;
		private System.Windows.Forms.DataGridViewTextBoxColumn colAccNum;
		private System.Windows.Forms.DataGridViewTextBoxColumn colGroupNum;
		private System.Windows.Forms.DataGridViewTextBoxColumn colReinspectNum;
		...
		private System.Windows.Forms.DataGridViewCheckBoxColumn col檢驗結果;
		private NGReasonColumn colNG原因;
